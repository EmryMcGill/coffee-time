        ...
        <View style={{flex: 1}}>
          ...
          >
            ...
            <Input 
              ...
              onChangeText={value => setUpdatedUser({...updatedUser, name: value})}
            ...
            <Input 
              icon={<Image source={require('../../../assets/images/machine.png')} style={styles.infoImg} />}
              placeholder='Enter your coffee machine'
              onChangeText={value => setUpdatedUser({...updatedUser, machine: value})}
            ...
            <Input 
              icon={<Image source={require('../../../assets/images/grinder.png')} style={styles.infoImg} />}
              placeholder='Enter your coffee grinder'
              onChangeText={value => setUpdatedUser({...updatedUser, grinder: value})}
